...
| **Отмена менее чем за 1 часа** | **"Заморожено"** | Отмена **блокируется**. Оплата остатка считается обязательной (см. ниже). |
...
| :---- | :---- | :---- |
| **За 1 час до выхода** | Гид получает уведомление о необходимости оплатить остаток. | **Расчет:** Система показывает Гиду точную сумму **Остатка к оплате**. |
...
| **Окончательная оплата** | Остаток полной стоимости оплачивается **за 1 час до выхода в море**. |
| **3\. ОТМЕНА** |  |
...
| **Полная невозвратная сумма** | Если отмена происходит **менее чем за 1 час** до выхода (после дедлайна окончательной оплаты), **вся сумма** (депозит \+ остаток) считается **полностью невозвратной**. |
| **4\. ПОСАДКА** |  |
