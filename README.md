...
- **Гиду** — о новых бронированиях с его группой + напоминание за 1 час до выхода
...
Команда `send_guide_reminders` должна запускаться каждые 15 минут для отправки напоминаний гидам за 1 час до выхода.
